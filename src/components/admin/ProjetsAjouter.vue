      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 class="text-2xl sm:text-3xl font-light text-gray-900">
            ...
            <span v-else>Ajouter</span> un projet résidentiel
          </h1>
          <p class="text-sm sm:text-base text-gray-500 mt-1">
            <span v-if="isEditing">Modifiez les informations du projet</span>
            <span v-else>Remplissez le formulaire pour ajouter un nouveau projet résidentiel</span>
          </p>
        </div>
        <RouterLink 
          to="/admin/projets"
    ...
    <form @submit.prevent="handleSubmit" class="bg-white rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg border border-gray-100">
        ...
        <div class="space-y-6">
          ...
          <div>
            ...
            <input 
              ...
              placeholder="Ex: Résidence Ambassade du Gabon"
            />
          </div>
          ...
          <div>
            ...
            <textarea 
              ...
              placeholder="Décrivez le projet résidentiel..."
            ></textarea>
          </div>
          ...
          <div>
            ...
            >
              ...
              <option value="complexe">Complexe résidentiel</option>
      ...
      <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-8 pt-6 border-t border-gray-100">
        ...
        >
          ...
          <span v-else>Enregistrer le projet</span>
        </button>
...
const handleSubmit = async () => {
  if (!form.name || !form.description || !form.location || !form.pieces || !form.type) {
  ...
  alert(isEditing.value ? '✅ Projet mis à jour avec succès !' : '✅ Projet ajouté avec succès !')
...
onMounted(() => {
  ...
  if (id) {
    ...
    form.name = 'Résidence Ambassade du Gabon'
    form.description = 'Une résidence prestigieuse...'
    form.location = 'Cocody, Abidjan'
    form.type = 'residence'
    form.pieces = '30'
    form.surface = '300'
    form.year = '2005'
